...
public class T_Coins : MonoBehaviour
{
    ...
    //    collision.gameObject.GetComponent<MNGChayTruongController>().AddCoins(value);
    ...
    //public void TryPickUp(MNGChayTruongController player)
    //{
